      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="py-16 sm:py-20 lg:py-28">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <Link to={'/explore'}>
                  <button className="max-w-[240px]   sm:w-auto bg-blue-600 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-full text-lg sm:text-xl font-semibold hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    Start Browsing
                  </button>
                </Link>
        ...
        <div className="py-12 sm:py-16 lg:py-20">
          ...
          <section className="mb-16 sm:mb-20 lg:mb-24">
            ...
            <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 sm:gap-8 lg:gap-10">
